...
for a = 1
    ...
    bins = [63e-7 20e-6 63e-6 0.0002 0.00063 0.002 0.0063 0.02 0.063 0.2 0.63]; %ISO 14688-1:2002 (International scale)
    bins_txt = {'silt' 'coarse silt' 'fine sand' ...
        'sand' 'course sand' 'fine gravel' 'gravel' ...
        ' course gravel' 'coble' 'boulder'};
...
for a = 1
    ...
    f1 = figure('units','centimeters','PaperUnits','centimeters', ...
        'PaperPosition',[0 0 pl.width 18],'Position',[1 1 pl.width 18], ...
...
for a = 1
    close all
    xd = 10^(log10(6.3e-6) + (log10(0.63)-log10(6.3e-6))*0.02);

    f2 = figure('units','centimeters','PaperUnits','centimeters', ...
        'PaperPosition',[0 0 pl.width pl.height],'Position',[100 5 pl.width pl.height], ...
        'PaperSize',[pl.width pl.height],'visible','on');
    ...
    set(gca,'Xscale','log');
    axis([63e-7 0.63 0 max(h_test.Values)*1.1]);
    ...
    set(gca,'Xscale','log');
    axis([63e-7 0.63 0 max(h.Values)*1.1]);
